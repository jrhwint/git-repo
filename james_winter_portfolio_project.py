...
def print_menu(Cart):
    ...
    print('c - Change item quantity, price, and description') # This changes more than quantity
    ...
    if option == 'q':
       return option
        ...
        print("CHANGE ITEM QUANTITY, PRICE, AND DESCRIPTION") # Instructions are ambiguous. Do you want the user to be able to modify everything or just quantity?
